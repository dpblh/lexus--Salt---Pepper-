$(document).ready(function () {
    ...
    $('<div id="loaderMask"><div class="preloaderImage"></div><div class="persentContainer"><div class="persentImage"></div></div></div>').css({
        position:"fixed",
        top:0,
        bottom:0,
        left:0,
    ...
    $('.preloaderImage').delay(500).fadeIn(function(e){
    ...
    function completeImageLoading(){
        ...
        $('.persentImage').width(percentage + '%');

        //When percentage is 100 we will remove loader and display page.
        if(percentage === 100){
            $('.preloaderImage, .persentContainer').delay(500).fadeOut(function(e){
